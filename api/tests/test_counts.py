...
class countsTester(TestCase):
    ...
    #     _upload_set = Dataset(upload_datetime=timezone.now())
    #     _upload_set.save()
    ...
    #     from ..indepProject.counts import count_coop_students_by_cohort
    #     _upload_set = Dataset(upload_datetime=timezone.now())
    #     _upload_set.save()
    ...
    def test_count_students_by_rank_semester(self):
        from ..indepProject.counts import semester_get_rank_counts
        _upload_set = Dataset(upload_datetime=timezone.now())
        _upload_set.save()
        student1 = Student(
            student_number = "3573669",name = "Fletcher Donaldson",campus = "FR",program ="BSSWE",
        ...
        rank_counts = list(semester_get_rank_counts("2021/WI").values()) # count_students_by_rank returns dictionary
